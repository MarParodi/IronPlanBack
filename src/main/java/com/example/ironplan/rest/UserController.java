...
public class UserController {
    ...
    private MeResponse buildMeResponse(User fullUser) {
        ...
        return new MeResponse(
                ...
                fullUser.getHeight(),
                fullUser.getGoal(),
                fullUser.getPersonalObjective(),
                fullUser.getPersonalObjectiveOther(),
                fullUser.getWeightUnit() != null ? fullUser.getWeightUnit() : com.example.ironplan.model.WeightUnit.KG,
